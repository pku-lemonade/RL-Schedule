    ...
    def execute(self, core):
        ...
        match self.operation:
            ...
            case OperatorType.CONV:
                ...
                yield env.process(
                    core.spm.release(self.input_size() + self.weight_size(), self.index)
                )
            ...
            case OperatorType.SEND:
                ...
                try:
                    with (
                        core.nmc.injection_ports.request() as inj_req,
                        ...
                        for son in self.successors:
                            ...
                            msg = Message(
                                ...
                                src_local_port=core.router.config.pe_local_port,
                                dst_local_port=core.router.config.pe_local_port,
