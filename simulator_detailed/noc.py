...
class Link:
    ...
    def __init__(
        ...
        *,
        ...
        self.serialization_noc_cycles = config.serialization_noc_cycles(self.flit_format)
        self.serialization_aci_cycles = config.serialization_aci_cycles(
            noc_cycles_per_aci_cycle, self.flit_format,
        )
...
class NoC:
    """Deterministic mesh with configured dimensions and timing."""
