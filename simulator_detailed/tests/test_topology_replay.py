...
class TopologyReplayTests(unittest.TestCase):
    def test_real_example_independent_routes_bytes_resources_and_trace_identity(self):
        ...
        self.assertEqual(result.elapsed_aci_cycles, 44)
        self.assertEqual(plan.topology.content_hash, "5ef712709c1afbfda6f795e119a4e4f2ce0f0437d7431f2a7be6285ffb15a6cc")
        self.assertEqual(plan.routing.plan_id, "1a59e3e5b7ed7c6155fe618ca13b025a9908959093d174eb89d9f1e3c8e09fba")
