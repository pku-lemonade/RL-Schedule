...
class FailurePredictor:
    ...
    def _load_model(self, model_path: str) -> HeteroTemporalModel:
        ...
        try:
            ...
            raise RuntimeError(
                "predictor checkpoint is incompatible with the configured "
    ...
    def predict_from_trace_dir(self, trace_dir: str, verbose: bool = True) -> Tuple[List[float], List[float], Dict[str, Any]]:
        """
        从trace目录进行预测
