...
def _get_predictor(mesh_x: int, mesh_y: int, fabric_ids: tuple[NoCChannel, ...]):
    cache_key = (mesh_x, mesh_y, fabric_ids, device, model_path, threshold, lookback, overlap_size)
...
def detect(
    ...
    builder = ManycoreDatasetBuilder(mesh_x, mesh_y, type, window_cfg, arch_config.noc.fabric_ids)
    ...
    predictor, cache_hit = _get_predictor(mesh_x, mesh_y, arch_config.noc.fabric_ids)
