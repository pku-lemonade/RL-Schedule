...
from predictor.data_loader import ManycoreDatasetBuilder, TimeWindowConfig
...
def detect(env_time: int, slice_num: int, arch_config: ArchConfig, core_events_json, link_events_json):
